...
void HAL_DCMI_MspDeInit(DCMI_HandleTypeDef* hdcmi)
{
  ...
  /* USER CODE END DCMI_MspDeInit 0 */
    ...
    PA6     ------> DCMI_PIXCLK
    */
    HAL_GPIO_DeInit(GPIOE, GPIO_PIN_0|GPIO_PIN_5|GPIO_PIN_1|GPIO_PIN_4
                          |GPIO_PIN_6);

    HAL_GPIO_DeInit(GPIOD, GPIO_PIN_3|GPIO_PIN_8);
...
void HAL_SD_MspInit(SD_HandleTypeDef* hsd)
{
  ...
  /* USER CODE END SDMMC1_MspInit 0 */
    ...
    PC8     ------> SDMMC1_D0
    */
    GPIO_InitStruct.Pin = GPIO_PIN_11|GPIO_PIN_10|GPIO_PIN_9|GPIO_PIN_12
                          |GPIO_PIN_8;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_SD_MspDeInit(SD_HandleTypeDef* hsd)
{
  ...
  /* USER CODE END SDMMC1_MspDeInit 0 */
    ...
    PC8     ------> SDMMC1_D0
    */
    HAL_GPIO_DeInit(GPIOC, GPIO_PIN_11|GPIO_PIN_10|GPIO_PIN_9|GPIO_PIN_12
                          |GPIO_PIN_8);
